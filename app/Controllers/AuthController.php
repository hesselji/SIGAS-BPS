...
final class AuthController
{
    ...
    public function login(): void
    {
        ...
        Auth::login($user);
        AuditLog::write((int) $user['id'], 'LOGIN', 'user', (int) $user['id']);
        header('Location: /dashboard');
        exit;
    }
    ...
    public function updatePassword(): void
    {
        ...
        AuditLog::write($userId, 'CHANGE_PASSWORD', 'user', $userId);
        session_regenerate_id(true);
        $_SESSION['flash_success'] = 'Password berhasil diperbarui. Password baru sudah dapat digunakan.';
        header('Location: /account/password');
        exit;
    }
    ...
    public function logout(): void
    {
        ...
        $id = Auth::id();
        if ($id) {
            AuditLog::write($id, 'LOGOUT', 'user', $id);
        }
        Auth::logout();
        header('Location: /login');
        exit;
