...
<section class="page-heading">
    <div>
        ...
        <p>Lengkapi data surat. Sistem akan membentuk nomor otomatis dari rule penomoran dan Kode Klasifikasi Arsip.</p>
    </div>
    ...
    <section class="panel form-panel">
        <form method="post" action="/letters" id="letterForm" class="modern-form" data-loading-form>
            ...
            <div class="form-actions-sticky">
                <div class="form-security-note"><?= ui_icon('lock') ?><span>Data dan KKA divalidasi kembali di server sebelum nomor dibuat.</span></div>
    ...
    <aside class="create-aside">
        <section class="panel preview-panel sticky-panel">
            ...
            <div class="preview-legend">
                ...
                <div><i class="green"></i><span>Kode unit / segmen</span></div>
                <div><i class="orange"></i><span>Klasifikasi KKA</span></div>
            </div>
            <div class="preview-info"><span><?= ui_icon('info') ?></span><p>Preview mengikuti pattern jenis surat. Sequence final tetap dibuat backend agar tidak terjadi duplikasi.</p></div>
        </section>
        <section class="panel aside-guide">
            <span class="eyebrow">ALUR SISTEM</span>
            <div class="guide-step"><b>1</b><div><strong>Validasi</strong><small>Jenis arsip, KKA, dan field surat dicek.</small></div></div>
            <div class="guide-step"><b>2</b><div><strong>Kunci Sequence</strong><small>Database mencegah nomor ganda.</small></div></div>
            <div class="guide-step"><b>3</b><div><strong>Generate</strong><small>Pattern rule diisi token secara otomatis.</small></div></div>
            <div class="guide-step"><b>4</b><div><strong>Simpan Record</strong><small>Nomor dan klasifikasi masuk ke agenda.</small></div></div>
        </section>
    </aside>
</div>
