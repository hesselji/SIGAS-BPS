...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/style.css?v=20260909-penamas-1">
</head>
...
<div class="app-layout">
    ...
    <aside class="sidebar" data-sidebar>
        <div class="brand-panel">
            <a class="brand" href="/dashboard" aria-label="PENA MAS">
                <span class="brand-logo-wrap">
                    <img src="/assets/images/penamas-icon.png" alt="Logo PENA MAS">
                </span>
                <span class="brand-copy">
                    <strong>PENA MAS</strong>
                    <small>Penomoran Agenda dan<br>Manajemen Arsip Surat</small>
                </span>
            </a>
        ...
        <nav class="sidebar-nav" aria-label="Navigasi utama">
            ...
            <a class="nav-item<?= nav_active('/account/password', true) ?>" href="/account/password">
                <span class="nav-icon"><?= ui_icon('lock') ?></span><span>Ganti Password</span>
            </a>
