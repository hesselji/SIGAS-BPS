...
<section class="page-heading">
    ...
    <div>
        ...
        <p>
            ...
            Pantau aktivitas agenda surat dan generate nomor
            dari satu dashboard.
        </p>
...
<section class="metric-grid">
    ...
    <article class="metric-card metric-neutral">
        ...
        <small>
            Tetap tersimpan dalam audit trail
        </small>
    ...
    <article class="panel status-panel">
        ...
        <div class="panel-heading">
            ...
            <div>
                ...
                <p>
                    Distribusi status nomor surat saat ini.
                </p>
        ...
        <div class="latest-list">
            ...
            <?php if (!$latest): ?>
                ...
                <div class="empty-mini">
                    ...
                    <small>
                        Generate nomor pertama untuk mulai
                        mengisi daftar.
                    </small>
            ...
            <?php else: ?>
                ...
                <?php foreach ($latest as $r): ?>
                    ...
                    <a
                        class="latest-item"
                        href="/letters/<?= (int) $r['id'] ?>"
                    >

                        <span class="latest-file-icon">
                            <?= ui_icon('file') ?>
                        </span>
    ...
    <article class="panel team-panel">
        ...
        <div class="panel-heading">
            ...
            <div>
                ...
                <p>
                    Perbandingan record berdasarkan tim.
                </p>

            </div>


            <span class="panel-icon-soft">
                <?= ui_icon('chart') ?>
            </span>
