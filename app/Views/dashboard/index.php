...
<section class="page-heading">
    <div>
        ...
        <p><?= e(format_date_id(date('Y-m-d'))) ?> • <?= \App\Core\Auth::isAdmin() ? 'Statistik global seluruh agenda surat keluar.' : 'Statistik pribadi surat keluar yang Anda buat.' ?></p>
    </div>
        ...
        <div class="latest-list">
            ...
            <?php else: foreach ($latest as $r): ?>
                <a class="latest-item" href="/letters/<?= (int)$r['id'] ?>">
                    ...
                    <span class="latest-main"><strong><?= e($r['letter_number']) ?></strong><small><?php $isSecret=in_array($r['sensitivity'],['RAHASIA','SANGAT_RAHASIA'],true); ?><?= $isSecret ? 'Detail terlindungi — verifikasi password untuk membuka' : e($r['subject']) ?></small></span>
...
<section class="dashboard-secondary-grid">
    ...
    <article class="panel quick-panel">
        <div class="panel-heading"><div><span class="eyebrow">AKSI CEPAT</span><h2>Mulai dari sini</h2><p>Akses fitur utama PENA MAS.</p></div></div>
        <div class="quick-grid">
            ...
            <?php if (\App\Core\Auth::isAdmin()): ?><a class="quick-card quick-muted" href="/incoming"><span><?= ui_icon('mail') ?></span><div><b>Surat Masuk</b><small>Agenda dan pencatatan surat masuk</small></div><?= ui_icon('arrow-right') ?></a><?php endif; ?>
        </div>
    </article>
</section>
